...
(function (global, factory) {
  ...
  var sweetHTML = '\n <div aria-labelledby="'
    ...
    .concat(swalClasses.progresssteps, '"></ul>\n     <div class="')
  ...
  var isValidParameter = function isValidParameter(paramName) {
    return (
      defaultParams.hasOwnProperty(paramName) || paramName === "extraParams"
    );
  };
  /**
      ...
      (function (_ParentSwal) {
        ...
        function SwalWithGlobalDefaults() {
          ...
          return _possibleConstructorReturn(
            this,
            _getPrototypeOf(SwalWithGlobalDefaults).apply(this, arguments)
          );
        }
          ...
          [
            {
              ...
              value: function _main(params) {
                return _get(
                  _getPrototypeOf(SwalWithGlobalDefaults.prototype),
                  "_main",
                  this
                ).call(this, _extends({}, defaults, params));
              },
            },
          ],
          [
  ...
  var defaultInputValidators = {
    email: function email(string, extraParams) {
      return /^[a-zA-Z0-9.+_-]+@[a-zA-Z0-9.-]+\.[a-zA-Z0-9-]{2,24}$/.test(
        ...
        ? Promise.resolve()
        : Promise.reject(
            extraParams && extraParams.validationMessage
              ? extraParams.validationMessage
...
if (typeof window !== "undefined" && window.Sweetalert2) {
  window.Sweetalert2.version = "7.28.12";
  window.swal =
    window.sweetAlert =
    window.Swal =
    window.SweetAlert =
